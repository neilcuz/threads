...
Well named objects and functions can improve readability, making some comments unnecessary.
...
You can document your package code using roxygen2 using the following syntax placed just before your function. This works inside of a package. You will need to install the roxygen2 package first.
