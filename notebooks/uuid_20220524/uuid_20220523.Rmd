...
It comes down to probability theory. Wikipedia has a good example. To have a 50% probability of at least 1 collision you would need to have 2.71 quintillion 
UUIDs. This number is so big you would need to generate a billion UUIDs every 
second for 85 years!
...
One thing to be aware of is memory. If storage space is a major issue for you 
then another approach might be more efficient because each UUID takes up 128 
bits. In most cases though this is not an issue.
