...
|:---|:-----|:--------|:---|:---|
|0014|DuckDB in R|An intro to using DuckDB with R|Thread not Live|[Go to Code](https://github.com/neilcuz/threads/blob/master/0014_duckdb-in-r/duckdb-in-r.md)|
